 ...
 */
declare const DERIVED_MODES: readonly ["type", "country", "region", "producer", "grape"];
type DerivedMode = typeof DERIVED_MODES[number];
type GroupingMode = DerivedMode | 'strategy' | 'custom';
